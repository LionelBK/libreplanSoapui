...
public class Methode4Test {
	...
	public static Collection<String[]> getTestCases() throws XmlException, IOException, SoapUIException {
		...
		WsdlProject project = new WsdlProject("src/test/resources/Rest-librePlan-readyapi-project-Copie.xml");
	...
	public static boolean runSoapUITestCase(String testCase) throws XmlException, IOException, SoapUIException {
		...
		WsdlProject soapuiProject = new WsdlProject("src/test/resources/Rest-librePlan-readyapi-project-Copie.xml");
